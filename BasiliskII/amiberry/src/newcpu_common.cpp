...
#if !defined(CPUEMU_21)
STATIC_INLINE uae_u32 next_iword_020ce(void) { return next_diword(); }
STATIC_INLINE uae_u32 next_ilong_020ce(void) { return next_dilong(); }
#endif
#if !defined(CPUEMU_23)
STATIC_INLINE uae_u32 next_iword_030ce(void) { return next_diword(); }
STATIC_INLINE uae_u32 next_ilong_030ce(void) { return next_dilong(); }
#endif
