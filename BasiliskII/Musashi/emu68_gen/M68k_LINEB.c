...
static uint32_t EMIT_CMPA(struct TranslatorContext *ctx, uint16_t opcode);

static uint32_t EMIT_CMPA_reg(struct TranslatorContext *ctx, uint16_t opcode);

static uint32_t EMIT_CMPA_mem(struct TranslatorContext *ctx, uint16_t opcode);
...
static uint32_t EMIT_CMP(struct TranslatorContext *ctx, uint16_t opcode);

static uint32_t EMIT_CMP_reg(struct TranslatorContext *ctx, uint16_t opcode);

static uint32_t EMIT_CMP_mem(struct TranslatorContext *ctx, uint16_t opcode);
...
static uint32_t EMIT_EOR(struct TranslatorContext *ctx, uint16_t opcode);

static uint32_t EMIT_EOR_reg(struct TranslatorContext *ctx, uint16_t opcode);

static uint32_t EMIT_EOR_mem(struct TranslatorContext *ctx, uint16_t opcode);
...
static uint32_t EMIT_CMPA(struct TranslatorContext *ctx, uint16_t opcode)
{
    return EMIT_CMPA_reg(ctx, opcode);
}

static uint32_t EMIT_CMPA_reg(struct TranslatorContext *ctx, uint16_t opcode)
{
    return EMIT_CMPA_mem(ctx, opcode);
}

static uint32_t EMIT_CMPA_mem(struct TranslatorContext *ctx, uint16_t opcode)
{
    return EMIT_CMPA_ext(ctx, opcode);
}

static uint32_t EMIT_CMP(struct TranslatorContext *ctx, uint16_t opcode)
{
    return EMIT_CMP_reg(ctx, opcode);
}

static uint32_t EMIT_CMP_reg(struct TranslatorContext *ctx, uint16_t opcode)
{
    return EMIT_CMP_mem(ctx, opcode);
}

static uint32_t EMIT_CMP_mem(struct TranslatorContext *ctx, uint16_t opcode)
{
    return EMIT_CMP_ext(ctx, opcode);
}

static uint32_t EMIT_EOR(struct TranslatorContext *ctx, uint16_t opcode)
{
    return EMIT_EOR_reg(ctx, opcode);
}

static uint32_t EMIT_EOR_reg(struct TranslatorContext *ctx, uint16_t opcode)
{
    return EMIT_EOR_mem(ctx, opcode);
}

static uint32_t EMIT_EOR_mem(struct TranslatorContext *ctx, uint16_t opcode)
{
    return EMIT_EOR_ext(ctx, opcode);
}
