                ...
                switch(size)
                {
                    ...
                    case SIZE_P:
                        ...
                        EMIT(ctx, 
                            ...
                            mov64_immed_u16(2, u.u16[0], 0),
                            movk64_immed_u16(2, u.u16[1], 1),
                            movk64_immed_u16(2, u.u16[2], 2),
                            movk64_immed_u16(2, u.u16[3], 3),
            ...
            case SIZE_P:
                ...
                if (imm_offset >= -255 && imm_offset <= 251)
                {
                    ...
                    EMIT(ctx, 
                        ...
                        mov64_immed_u16(1, u.u16[0], 0),
                        movk64_immed_u16(1, u.u16[1], 1),
                        movk64_immed_u16(1, u.u16[2], 2),
                        movk64_immed_u16(1, u.u16[3], 3),
...
{
    __asm__ volatile(
        ".globl _clear_entire_dcache\n"
        "_clear_entire_dcache:\n"
        "ret\n"
    );
}
...
{
    __asm__ volatile(
        ".globl _invalidate_entire_dcache\n"
        "_invalidate_entire_dcache:\n"
        "ret\n"
    );
}
    ...
    if (opcode == 0xf200 && (opcode2 & 0xfc00) == 0x5c00)
    {
        ...
        */
        if (offset == C_10P0) {
            ...
            EMIT(ctx, 
                mov64_immed_u16(0, u.u16[0], 0),
                movk64_immed_u16(0, u.u16[1], 1),
                movk64_immed_u16(0, u.u16[2], 2),
                movk64_immed_u16(0, u.u16[3], 3),
...
uint32_t EMIT_lineF(struct TranslatorContext *ctx)
{
    ...
    else if ((opcode & 0xff20) == 0xf400 && (opcode & 0x0018) != 0)
    {
        ...
        if (opcode & 0x80) {
            ...
            EMIT(ctx, 
                mov64_immed_u16(3, u.u16[0], 0),
                movk64_immed_u16(3, u.u16[1], 1),
                movk64_immed_u16(3, u.u16[2], 2),
                movk64_immed_u16(3, u.u16[3], 3),
                adr(2, 4*2),
                br(3)
            );
