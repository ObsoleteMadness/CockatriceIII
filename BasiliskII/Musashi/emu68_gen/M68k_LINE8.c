...
uint32_t EMIT_PACK_mem(struct TranslatorContext *ctx, uint16_t opcode);
...
uint32_t EMIT_UNPK_mem(struct TranslatorContext *ctx, uint16_t opcode);
...
uint32_t EMIT_OR_ext(struct TranslatorContext *ctx, uint16_t opcode);

uint32_t EMIT_OR_mem(struct TranslatorContext *ctx, uint16_t opcode);
...
uint32_t EMIT_PACK_mem(struct TranslatorContext *ctx, uint16_t opcode)
{
    return EMIT_PACK_reg(ctx, opcode);
}

uint32_t EMIT_UNPK_mem(struct TranslatorContext *ctx, uint16_t opcode)
{
    return EMIT_UNPK_reg(ctx, opcode);
}

uint32_t EMIT_OR_ext(struct TranslatorContext *ctx, uint16_t opcode)
{
    return EMIT_OR_reg(ctx, opcode);
}
