...
static uint32_t EMIT_ADD(struct TranslatorContext *ctx, uint16_t opcode);

static uint32_t EMIT_ADD_reg(struct TranslatorContext *ctx, uint16_t opcode);

static uint32_t EMIT_ADD_mem(struct TranslatorContext *ctx, uint16_t opcode);
...
static uint32_t EMIT_ADDA(struct TranslatorContext *ctx, uint16_t opcode);

static uint32_t EMIT_ADDA_reg(struct TranslatorContext *ctx, uint16_t opcode);

static uint32_t EMIT_ADDA_mem(struct TranslatorContext *ctx, uint16_t opcode);
...
// BROKEN!!!
static uint32_t EMIT_ADDX(struct TranslatorContext *ctx, uint16_t opcode);

static uint32_t EMIT_ADDX_reg(struct TranslatorContext *ctx, uint16_t opcode);
...
static uint32_t EMIT_ADD(struct TranslatorContext *ctx, uint16_t opcode)
{
    return EMIT_ADD_reg(ctx, opcode);
}

static uint32_t EMIT_ADD_reg(struct TranslatorContext *ctx, uint16_t opcode)
{
    return EMIT_ADD_mem(ctx, opcode);
}

static uint32_t EMIT_ADD_mem(struct TranslatorContext *ctx, uint16_t opcode)
{
    return EMIT_ADD_ext(ctx, opcode);
}

static uint32_t EMIT_ADDA(struct TranslatorContext *ctx, uint16_t opcode)
{
    return EMIT_ADDA_reg(ctx, opcode);
}

static uint32_t EMIT_ADDA_reg(struct TranslatorContext *ctx, uint16_t opcode)
{
    return EMIT_ADDA_mem(ctx, opcode);
}

static uint32_t EMIT_ADDA_mem(struct TranslatorContext *ctx, uint16_t opcode)
{
    return EMIT_ADDA_ext(ctx, opcode);
}

static uint32_t EMIT_ADDX(struct TranslatorContext *ctx, uint16_t opcode)
{
    return EMIT_ADDX_reg(ctx, opcode);
}

static uint32_t EMIT_ADDX_reg(struct TranslatorContext *ctx, uint16_t opcode)
{
    return EMIT_ADDX_mem(ctx, opcode);
}
